...
export { getAnswerCandidates, getLongestReferenceText };
...
export function measureTextWidthForElement(text, element) {
    const canvas =
        measureTextWidthForElement._canvas ||
        (measureTextWidthForElement._canvas = document.createElement('canvas'));
...
export function applyAutoWidthForContainer(container) {
    ...
    const inputs = container.querySelectorAll(
        '.overview-question input[data-answer]'
    );
...
export function protectHomeProjectInputs() {
    const homeProjectInputs = document.querySelectorAll(
